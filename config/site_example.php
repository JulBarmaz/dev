...
//	public static	$gzipMode	= false;
	...
	public static	$siteDomain			= '###SITE_DOMAIN###';
	public static	$sitePort			= '###SITE_PORT###';
	public static	$siteSSLPort		= '###SITE_SSL_PORT###';
	// Site template
	public static	$siteTemplate		= '###SITE_TEMPLATE###';
	...
	// Site title
	public static	$metaTitle			= "###SITE_TITLE###";
	// Site description
