...
<body>
	<div id="error_body">
		<div id="error_header">
			<div id="logo" class="logo404" onclick="javascript: document.getElementById('loginForm').style.display='block';"></div>
			<div id="headLine"></div>
		</div>
		...
		<div class="fatal-error-link"><a class="go_back" href="<?php echo ($url ? $url : "/");?>"><?php echo $url ? Text::_('Continue') : Text::_('Go main page');?></a></div>
	</div>
