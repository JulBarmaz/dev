...
$cur_table_arr = array(
			"field"		=> array(1=>'vg_id','vg_alias','vg_group_id','vg_title','vg_thumb','vg_title_thm','vg_alt_thm','vg_comment','vg_ordering','vg_show_in_list','vg_published','vg_deleted','vg_meta_title','vg_meta_description','vg_meta_keywords'),
			"name"		=> array(1=>'ID','Alias','Group','Title','Thumb','Title image','Alt image','Comments','Ordering','Show in list','Published','Delete mark','Meta title','Meta description','Meta keywords'),
			"link"		=> array(4=>"index.php?module=videoset&view=videos&psid=[0]"),
			"link_key"	=> array(4=>'id'),
			"link_type"	=> array(4=>''),
			"val_type"	=> array(1=>'int','string','int','string','string','string','string','text','int','boolean','boolean','boolean','string','text','text'),
			"input_type"	=> array(1=>'hidden','text','select','text','image','text','text','texteditor','text','checkbox','checkbox','hidden','text','textarea','textarea'),
