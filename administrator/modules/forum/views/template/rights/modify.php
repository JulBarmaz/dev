...
<div class="container"><div class="row"><div class="col-md-12"><div class="acl-manager rounded-pan rounded-pan-mini">
	<h4 class="title"><?php echo Text::_('Forum rights')." (".Text::_('Forum')."&nbsp;".$this->forum_name.")&nbsp;".Text::_('for')."&nbsp;".$this->subjectName; ?></h4>
	<form action="index.php" method="post">
		...
		<?php foreach ($this->actions as $action) {
			...
			<div class="row">
				<div class="col-xs-8">
					...
					<?php echo HTMLControls::renderLabelField("access_".$action, Text::_("forum_".$action)); ?>
				</div>
				<div class="col-xs-4">
		...
		<?php } ?>
		<div class="buttons">
			<input type="submit" class="commonButton btn btn-info" name="save" value="<?php echo Text::_('Save'); ?>" />
			<input type="submit" class="commonButton btn btn-info" name="apply" value="<?php echo Text::_('Apply'); ?>" />
			<input type="button" class="commonButton btn btn-info" onclick="javascript:document.location.href='<?php echo Router::_("index.php?module=forum&view=rights&psid=".$this->psid); ?>'; return true;" value="<?php echo Text::_('Cancel'); ?>" name="cancel" />
		</div>
	</form>
</div>