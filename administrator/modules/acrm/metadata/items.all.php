...
$keystring='b_id';
$deleted='b_deleted';
$nametabl="All ACRM items";
$enabled="b_enabled";
$ordering_field	= "b_ordering";		// Поле порядка отображения
$buttons=array(
	    "go_up"=> array("show"=>0,"link"=>false),
			"new"=>array("show"=>1,"view"=>"items","layout"=>"all","task"=>"modify"),
			"filter"=>array("show"=>1,"view"=>"items"),
			"modify"=>array("show"=>1,"view"=>"items","layout"=>"all","task"=>"modify"),
			"delete"=>array("show"=>1,"view"=>"items","layout"=>"all","task"=>"delete"),
			"undelete"=>array("show"=>1,"view"=>"items","layout"=>"all","task"=>"delete"),
...
$cur_table_arr=array(
				...
				"input_type"=>array(1=>'hidden', 'select', 'select', 'text', 'text', 
