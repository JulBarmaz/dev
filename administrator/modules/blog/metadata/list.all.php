...
$buttons = array(
			...
			"new"		=> array("show"=>1,"view"=>"list","layout"=>"all","task"=>"modify"),
			"filter"	=> array("show"=>1,"view"=>"list"),
			"modify"	=> array("show"=>1,"view"=>"list","layout"=>"all","task"=>"modify"),
			"modify_links"=>array("show"=>0,"view"=>"list","layout"=>"all","task"=>"modifyLinks"),
			"delete"	=> array("show"=>1,"view"=>"list","layout"=>"all","task"=>"delete"),
			"undelete"	=> array("show"=>1,"view"=>"list","layout"=>"all","task"=>"delete"),
