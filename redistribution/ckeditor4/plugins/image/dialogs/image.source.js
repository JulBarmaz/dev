					...
					elements: [ {
						...
						children: [ {
							...
							},
							{
								...
								// changes by Radius17 start
								onClick : function() {	
									$('#'+this.getDialog().getContentElement( 'info', 'txtUrl' )._.inputId).live('change',function(){
										CKEDITOR.dialog.getCurrent().getContentElement( 'info', 'txtUrl' ).onChange();
									})
									mm_startMediaManager(this.getDialog().getContentElement( 'info', 'txtUrl' )._.inputId, editor.config.useAbsoluteLinks);
								},
								hidden: (editor.config.showFileBrowserButton==1 ? false : true),
								// hidden: true,
								// filebrowser: 'info:txtUrl'
								// changes by Radius17 stop
							} ]
						} ]
					},
					{
