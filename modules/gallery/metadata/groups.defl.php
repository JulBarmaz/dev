...
$cur_table_arr = array(
			"field"		=> array(1=>'gr_id','gr_alias','gr_title','gr_thumb','gr_title_thm','gr_alt_thm','gr_comment','gr_ordering','gr_show_in_list','gr_published','gr_deleted','gr_layout'),
			"name"		=> array(1=>'ID','Alias','Title','Thumb','Title image','Alt image','Comments','Ordering','Show in list','Published','Deleted','Layout'),
			"link"		=> array(3=>"index.php?module=gallery&view=items&psid=[0]"),
			"link_key"	=> array(3=>'id'),
			"link_type"	=> array(3=>''),
			"val_type"	=> array(1=>'int','string','string','string','string','string','text','int','boolean','boolean','boolean','string'),
			"input_type"	=> array(1=>'hidden','text','text','image','text','text','texteditor','text','checkbox','checkbox','hidden','text'),
