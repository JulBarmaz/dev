	...
	<div style="display:table;border-top:1px solid #ddd;border-left:1px solid #ddd; margin-bottom: 12px;width:100%;">
		...
		<?php foreach($items as $g) { ?>
			...
			<div style="display:table-row;">
				...
				<?php if($show_prices){?>
					<div id="sum_<?php echo $g->i_g_id;?>" style="display:table-cell;text-align:right;white-space:nowrap;padding:6px 4px;border-bottom:1px solid #ddd;border-right:1px solid #ddd;">
...
<!-- SPECIALLY FOR USER :) -->
<h4><?php echo Text::_("Thank you for your order"); ?></h4>
<br /><br /><a id="print_but" target="_blank" href="<?php echo Router::_("index.php?module=catalog&view=orders&layout=order&order_id=".$order->o_id.($order->o_hash ? "&order_hash=".$order->o_hash : ""), false, true, 1, 2); ?>"><?php echo Text::_('Link to order'); ?></a>
